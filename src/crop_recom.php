...
<header class="flex justify-between  items-center bg-gray-950 h-15 sticky  z-20 border-b-2 border-b-gray-900 top-0 pl-3 pr-3">
    ...
    <div class="text-gray-400 flex items-center gap-5 border-2 border-gray-800 rounded-2xl pl-4 pr-4 pt-1 pb-1">
        <a href="./homePage.php" class="hover:text-white hover-effect">Home</a>
        <a href="./SUNSIDIES.php" class="hover:text-white hover-effect">Subsidies</a>
        <a href="./blog.php" class="hover:text-white hover-effect">Blog</a>
        <a href="./homePage.php#About" class="hover:text-white hover-effect">About us</a>
    </div>
    ...
    <div class="relative">
            ...
            <div id="profile-menu" class="hidden absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl py-2 transition-effect">
                ...
                <a href="./login.php" class="block px-4 py-2 text-white hover:bg-gray-700 hover-effect">Logout</a>
            </div>
        </div>
</header>
